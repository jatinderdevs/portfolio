            ...
            <div class="row align-items-center ">
                <div class="col-md-6 ">
                    <div class="bannertxt" data-aos="fade-right">
                        ...
                        <p>Want to rank higher on Google or engage your audience on social media? JatinderDev offers
                            expert SEO and social media marketing services in Melbourne. Our strategies drive traffic,
                            increase brand visibility, and generate leads for local businesses.
                        </p>
                        <a target="_blank"
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="project" data-aos="flip-right">
                        <div class="projectImg marketingWork">
                            <img src="img/digital-marketing/arr-logistics-logo.webp" width="75%" class="img-fluid"
                                alt="">
                        </div>
                        <div class="projectTitle">
